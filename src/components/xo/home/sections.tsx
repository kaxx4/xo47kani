...
export function Services({ t }: { t: MoodTheme }) {
  return (
    <section style={{ background: t.alt, color: t.text, padding: "var(--sec) 0" }}>
      <div className="wrap">
        <Reveal>
...
export function CTABand() {
  return (
    <section style={{ background: "var(--ink)", color: "var(--milk)", padding: "var(--cta) 0", textAlign: "center", overflow: "hidden" }}>
      <div className="wrap">
